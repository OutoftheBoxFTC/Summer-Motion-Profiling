...
hardware.Hardware:	This is NOT an OpMode, but a helper class that is used to describe
...
* hardware.Hardware class names are constructed as:  hardware.Hardware - Robot type
